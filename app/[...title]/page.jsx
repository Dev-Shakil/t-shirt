  ...
  return (
    ...
    <div className="container flex px-5 py-24 mx-auto">
      {/* <div className="lg:w-4/5 mx-auto flex flex-wrap"> */}
        <div className="lg:w-1/2 w-full gap-x-2 flex">
          ...
          images?.map((currImg,index)=>{
            return(
              <figure>
                <Image onClick={()=>{setMyimg(currImg)}} src={currImg} alt={"sonot"} className="w-full lg:h-[130px] h-64 object-cover object-center rounded" key={index} height={400}
                width={400}/>
              </figure>
            )
          })
            ...
            <div className="flex items-center">
              ...
              <div className="flex gap-x-2 flex-wrap">
                <div className="rounded border appearance-none border-gray-300 py-2  text-base px-3 flex">
                  <p>SM :</p>
                  <input className="ml-2 outline-none focus:outline-none w-10" type="number" name="sm" id="sm" defaultValue="0" />
                </div>
                <div className="rounded border appearance-none border-gray-300 py-2  text-base px-3 flex">
                  <p>M :</p>
                  <input className="ml-2 outline-none focus:outline-none w-10" type="number" name="sm" id="sm" defaultValue="0" />
